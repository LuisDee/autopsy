...
- All generated AGENTS.md files include a `<!-- generated by autopsy -->` marker
- **With marker** (autopsy generated): Regenerate entirely on re-run — prevents duplication
- **Without marker** (manually written): Preserve manual content, append autopsy content below a separator
