...
## Purpose
Agent definition files for the 7 specialized sub-agents used in deep-review. Each agent has a specific domain expertise and produces findings in a standardized format.
